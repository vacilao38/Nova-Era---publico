---
tipo: conselho independente
origem: Alfheim
vínculo: vontade popular
status: cânone institucional; composição e procedimento pendentes
atualizado: 2026-08-09
---

# Conselho dos Sábios

Órgão independente de [[Alfheim|Alfheim]] criado para defender os desejos do povo em decisões institucionais de grande alcance.
...
- quantidade e identidade dos sábios;
- forma de escolha ou reconhecimento dos integrantes;
- maneira pela qual a vontade do povo é consultada;
- poder de voto, veto, parecer ou revisão;
- duração da participação em cada caso;
- relação do Conselho com autoridades territoriais e com a coroa.
