...
MANSÃO MAGNÍFICA DE MORDENKAINEN 7° nível de conjuração

- **Tempo de Conjuração:** 1 minuto
- **Alcance:** 90 metros
- **Componentes:** V, S, M (um portal em miniatura
esculpido em marfim, um pedaço de mármore polido e uma pequena colher de prata, cada item valendo, no mínimo, 5 po)
